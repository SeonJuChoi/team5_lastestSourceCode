    ...
    methods : {
      ...
      getCustomerRating(){
        ...
        then((response)=>{
          ...
          console.log(this.getRatingScore[0].length);
          console.log(this.getRatingScore[0]['totalRating']);

          var ratingScoreNumber = [];

          ratingScoreNumber.push(Number(this.getRatingScore[0]['totalRating']));
          ratingScoreNumber.push(Number(this.getRatingScore[0]['taste']));
          ratingScoreNumber.push(Number(this.getRatingScore[0]['service']));
          ratingScoreNumber.push(Number(this.getRatingScore[0]['mood']));
          ratingScoreNumber.push(Number(this.getRatingScore[0]['price']));

          console.log(ratingScoreNumber);
            ...
            datasets: [
              {
                ...
                fill: true,
                // borderWidth: 1,
                data                  : [ratingScoreNumber[0], ratingScoreNumber[1],
                ratingScoreNumber[2],ratingScoreNumber[3],ratingScoreNumber[4]],
