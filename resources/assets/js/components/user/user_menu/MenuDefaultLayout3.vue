...
@media (max-width: 639px){   
    .menu3_body      { width:100%; margin-bottom:1%;}  
    .menu3_name      { font-size: 0.8rem; }
    .menu3_expl      { font-size: 0.8rem; padding-bottom: 30%; margin: auto; margin-bottom: 5%;}    
    .menu3_remark    { font-size: 0.5rem; }    
    .menu3_price     { font-size: 1rem; margin: auto; margin-bottom: 15%;}    
    .menu3_select    { font-size: 0.5rem; }
}
